      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex-1 min-w-0 h-full flex items-center justify-center px-2 text-[14px] font-medium rounded-[3px] transition-colors duration-150 ease-in-out select-none outline-none overflow-hidden",
              isActive
