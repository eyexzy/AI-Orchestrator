        ...
        createPortal(
          <div
            ...
            style={{
              top: position.top,
              left: position.left,
              transform: `translate(${align === "center" ? "-50%" : align === "end" ? "-100%" : "0"}, calc(-100% - 6px))`,
            }}
          >
            <div className="animate-in fade-in duration-150">
              <div
                className={cn(
                  "relative w-max max-w-[280px] rounded-md bg-gray-1000 px-3 py-2 text-left text-[12px] font-medium leading-relaxed text-gray-100 after:absolute after:bottom-[-4px] after:h-2 after:w-2 after:rotate-45 after:bg-gray-1000 after:content-['']",
